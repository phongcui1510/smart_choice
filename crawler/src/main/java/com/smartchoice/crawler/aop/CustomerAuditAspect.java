...
//    @Before("execution(* com.smartchoice.crawler.controller.ProductController.getProductByKeyword(..))")
//    @Async
//    public void logUserViewProduct(JoinPoint joinPoint) {
//        Object[] methodArguments = joinPoint.getArgs();
//        String keyword = (String) methodArguments[0];
//        CustomerActivity customerActivity = new CustomerActivity(null, LocalDateTime.now(), keyword);
